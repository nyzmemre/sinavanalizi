                        ...
                        return ElevatedButton(
                            onPressed: () {
                              if (_key.currentState!.validate()) {
                                _loginViewModel.registerUserAndAddToFirestore(
                                    email: emailCtrl.text, password: passwordCtrl.text, name: nameCtrl.text,
                                    surname: surnameCtrl.text, branch: provider.branch, city: provider.city,
                                    district: provider.district, schoolID: 'schoolID',
      ...
      return Column(
        children: [
          ...
          CustomTextFormField(
            ...
            passwordMatch: passwordCtrl.text,
            isVisible: (provider.isVisible) ? false : true,
            validator: (value) {
