...
class CustomDropdownMenuDistrict extends StatefulWidget {
  const CustomDropdownMenuDistrict({super.key, required this.list});
  final List<String> list;

  @override
  State<CustomDropdownMenuDistrict> createState() => _DropdownMenuExampleState();
}

class _DropdownMenuExampleState extends State<CustomDropdownMenuDistrict> {
